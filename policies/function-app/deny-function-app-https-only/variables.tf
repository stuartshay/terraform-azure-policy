# Variables for the Function App HTTPS-Only Policy Module
...
variable "policy_assignment_name" {
  ...
  type        = string
  default     = "deny-function-app-https-only-assignment"
}

variable "policy_assignment_display_name" {
  description = "Display name for the policy assignment"
  type        = string
  default     = "Deny Function App Non-HTTPS Access Assignment"
}

variable "policy_assignment_description" {
  description = "Description for the policy assignment"
  type        = string
  default     = "This assignment enforces the policy to deny Function Apps that do not require HTTPS-only connections."
}
