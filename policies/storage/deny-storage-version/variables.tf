# Variables for the Storage Blob Versioning Policy Module
...
variable "policy_assignment_name" {
  ...
  type        = string
  default     = "deny-storage-version-assignment"
}

variable "policy_assignment_display_name" {
  description = "Display name for the policy assignment"
  type        = string
  default     = "Deny Storage Account Without Blob Versioning Assignment"
}

variable "policy_assignment_description" {
  description = "Description for the policy assignment"
  type        = string
  default     = "This assignment enforces the policy to deny storage accounts that have blob versioning disabled."
}
